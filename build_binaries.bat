...
if exist "%ROOT_DIR%dist\windows-amd64" (
    copy /y "%ROOT_DIR%inspector.html" "%ROOT_DIR%dist\windows-amd64\inspector.html" >nul
    copy /y "%ROOT_DIR%inspector_v2.html" "%ROOT_DIR%dist\windows-amd64\inspector_v2.html" >nul
)
if exist "%ROOT_DIR%dist\windows-amd64\controlplane" (
    copy /y "%ROOT_DIR%inspector.html" "%ROOT_DIR%dist\windows-amd64\controlplane\inspector.html" >nul
    copy /y "%ROOT_DIR%inspector_v2.html" "%ROOT_DIR%dist\windows-amd64\controlplane\inspector_v2.html" >nul
)
if exist "%ROOT_DIR%dist\windows-amd64\dashboard" (
    copy /y "%ROOT_DIR%inspector.html" "%ROOT_DIR%dist\windows-amd64\dashboard\inspector.html" >nul
    copy /y "%ROOT_DIR%inspector_v2.html" "%ROOT_DIR%dist\windows-amd64\dashboard\inspector_v2.html" >nul
)
