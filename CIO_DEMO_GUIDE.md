...
By default, BAP may be configured to connect to a corporate intranet host (e.g. `http://amn010731.nomura.com:8080` in `bap-config.json`). If you are demonstrating on a local machine, isolated laptop, or outside the corporate VPN, you have two options:
...
.\configure_endpoints.bat http://amn010731.nomura.com:8080 http://amn010731.nomura.com:9090
```
